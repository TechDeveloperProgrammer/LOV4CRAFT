...
public class AIConfig {
    ...
    public RateLimitConfig getRateLimitConfig(String serviceName) {
        ServiceConfig config = getServiceConfig(serviceName);
        return config != null ? config.getRateLimitConfig() : new RateLimitConfig();
    }

    public MetricsConfig getMetricsConfig(String serviceName) {
        ServiceConfig config = getServiceConfig(serviceName);
        return config != null ? config.getMetricsConfig() : new MetricsConfig();
    }
}
